    ...
    <aside aria-label="Topic navigation">
      {loading ? (
        ...
        >
          ...
          <span className={styles.srOnly}>Loading topics...</span>
        </div>
      ) : (
        <nav className={styles.sidebar} aria-label="Topics and pages">
            ...
            {topics.map((topic) => (
              <li key={topic.slug} className={styles.sidebarLi}>
                <Link
                  ...
                  className={styles.sidebarLink}
                  aria-label={`Articles on ${topic.slug}`}
                >
                  {topic.img_url && (
